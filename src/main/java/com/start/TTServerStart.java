...
public class TTServerStart {
	...
	public static void main(String[] args) {
		...
		try {
			...
			logger.info("====== server info threadPool:" +((QueuedThreadPool)srvStart.server.getThreadPool()).toString());
			logger.info("====== server info ChildHanders:" + java.util.Arrays.toString(srvStart.server.getChildHandlers()));
			logger.info("====== server info maxFormContentSize:" + srvStart.server.getAttribute("org.eclipse.jetty.server.Request.maxFormContentSize"));
